 ...
 * PLACE ANY CUSTOMIZATIONS IN ums_teacher
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class ums_teacher_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'ums_teacher';
    public $object_name = 'ums_teacher';
    public $table_name = 'ums_teacher';
     ...
     */
    public function ums_teacher_sugar()
    {
        self::__construct();
    }
