 ...
 * PLACE ANY CUSTOMIZATIONS IN ums_student
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class ums_student_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'ums_student';
    public $object_name = 'ums_student';
    public $table_name = 'ums_student';
     ...
     */
    public function ums_student_sugar()
    {
        self::__construct();
    }
