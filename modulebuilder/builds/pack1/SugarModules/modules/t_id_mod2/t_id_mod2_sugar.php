 ...
 * PLACE ANY CUSTOMIZATIONS IN t_id_mod2
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class t_id_mod2_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 't_id_mod2';
    public $object_name = 't_id_mod2';
    public $table_name = 't_id_mod2';
     ...
     */
    public function t_id_mod2_sugar()
    {
        self::__construct();
    }
