 ...
 * PLACE ANY CUSTOMIZATIONS IN t_id_mod1
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class t_id_mod1_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 't_id_mod1';
    public $object_name = 't_id_mod1';
    public $table_name = 't_id_mod1';
     ...
     */
    public function t_id_mod1_sugar()
    {
        self::__construct();
    }
