...
class TemplateNewtype extends TemplateField {
	var $type = 'varchar';
     ...
     * Description:        Get the field definition attributes that are required for the Newtype Field
     *                      the primary reason this function is here is to set the dbType to 'varchar',
     *                      otherwise 'Newtype' would be used by default.
