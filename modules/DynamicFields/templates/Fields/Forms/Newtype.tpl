...
<tr>
    <td class='mbLBL'>{sugar_translate module="DynamicFields" label="LBL_NEWTYPE_BACKCOLOR"}:</td>
    <td>
        {if $hideLevel < 5}
            {html_options name="ext1" id="ext1" selected=$BACKCOLOR options=$newtypeColors}
        {else}
...
<tr>
    <td class='mbLBL'>{sugar_translate module="DynamicFields" label="LBL_NEWTYPE_TEXTCOLOR"}:</td>
    <td>
        {if $hideLevel < 5}
            {html_options name="ext2" id="ext2" selected=$TEXTCOLOR options=$newtypeColors}
        {else}
